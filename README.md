...
__[Клонирование Репозитория c Github себе на компьютер, чтобы вести работу с кодом локально.](#rep_work_1)<br>
__[Работаем с кодом на компьюторе локально.](#rep_work_2)<br>
____[а. Работа в Ветке на компьюторе](#rep_work_2_a)<br>
____[b. Сохранение проекта на компьюторе локално](#rep_work_2_b)<br>
____[с-1. Отправляем изменения с компьютора на Github в конкретную (не мастер) ветку](#rep_work_2_c_1)<br>
____[с-2. Отправляем изменения с компьютора на Github в мастер ветку ](#rep_work_2_c_2)<br>
[4. Коротко-Команды Git в Терминале](#com's_git)<br>
__[Если Репозиторий создан онлайн на сайте Github](#com's_git_1)<br>
__[Cоздание Репозитория в Терминале при помощи Hub](#com's_git_2)<br>
