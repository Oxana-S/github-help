...
- [Клонирование Репозитория c Github себе на компьютер, чтобы вести работу с кодом локально.](#rep_work_1)
- [Работаем с кодом на компьюторе локально.](#rep_work_2)   
  [а. Работа в Ветке на компьюторе](#rep_work_2_a)   
  [b. Сохранение проекта на компьюторе локално](#rep_work_2_b)   
  [с-1. Отправляем изменения с компьютора на Github в конкретную (не мастер) ветку](#rep_work_2_c_1)    
  [с-2. Отправляем изменения с компьютора на Github в мастер ветку ](#rep_work_2_c_2)   
[4. Коротко-Команды Git в Терминале](#com's_git)
- [Если Репозиторий создан онлайн на сайте Github](#com's_git_1)  
- [Cоздание Репозитория в Терминале при помощи Hub](#com's_git_2)    
...
## <a name="rep_work_2_c_1"></a>с-1. Отправляем изменения с компьютора на Github в конкретную (не мастер) ветку    
...
## <a name="rep_work_2_c_2"></a>с-2. Отправляем изменения с компьютора на Github в мастер ветку    
...
##   <a name="com's_git_1"></a> ВАРИАНТ-1: Если Репозиторий создан онлайн на сайте Github
...
## <a name="com's_git_2"></a>ВАРИАНТ-2: Cоздание Репозитория в Терминале при помощи Hub
