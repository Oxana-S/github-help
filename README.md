...
____[с. Отправляем изменения с компьютора на Github в конкретную (не мастер) ветку](#rep_work_2_c_1)<br>
____[d. Отправляем изменения с компьютора на Github в мастер ветку ](#rep_work_2_c_2)<br>
...
##   <a name="com's_git_1"></a>  1) Если Репозиторий создан онлайн на сайте Github
...
## <a name="com's_git_2"></a> 2) Cоздание Репозитория в Терминале при помощи Hub      
