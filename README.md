...
> **Git и Github. Простые рецепты** [Ссылка на статью. Подробно описан процес и команды работы с Git b Github](https://habr.com/ru/post/273897/). 
...
__[3) Полезные ссылки по Hub](#com's_git_3)
