...
__[1)Клонирование Репозитория c Github себе на компьютер, чтобы вести работу с кодом локально.](#rep_work_1)<br>
__[2)Работаем с кодом на компьюторе локально.](#rep_work_2)<br>
...
__[1)Если Репозиторий Уже создан онлайн на сайте Github](#com's_git_1)<br>
__[2)Cоздание Репозитория на Github удаленно, на компьюторе в Терминале при помощи Hub](#com's_git_2)<br>
