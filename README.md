...
+ [ВАРИАНТ-1: Если Репозиторий создан онлайн на сайте Github](#com's_git_1)    
+ [ВАРИАНТ-2: Cоздание Репозитория в Терминале при помощи Hub](#com's_git_2)    
...
### b. Сохранение проекта на компьюторе локално    
